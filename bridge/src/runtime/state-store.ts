...
function migrateTaskBranch(input: any): TaskBranchRecord {
  return {
    ...
    currentGitHead: typeof input.currentGitHead === "string" ? input.currentGitHead : undefined,
    gitBranchName: typeof input.gitBranchName === "string" ? input.gitBranchName : undefined,
    isolationMode: ["in_place", "git_worktree", "copy_workspace"].includes(String(input.isolationMode)) ? input.isolationMode : "in_place",
    workspacePath: typeof input.workspacePath === "string" ? input.workspacePath : undefined,
    worktreeCreatedAt: typeof input.worktreeCreatedAt === "string" ? input.worktreeCreatedAt : undefined,
    worktreeStatus: ["not_created", "creating", "ready", "failed", "cleaned_up"].includes(String(input.worktreeStatus)) ? input.worktreeStatus : "not_created",
...
function migrateWebPatch(input: any): WebPatch {
  ...
  return {
    ...
    lastPreflightReport: input.lastPreflightReport,
