...
export const MIN_NODE_MAJOR = Number(process.env.BRIDGE_MIN_NODE_MAJOR || 24);
...
export const MAX_CONTEXT_RETRIEVE_FILES = 12;
export const MAX_CONTEXT_RETRIEVE_SNIPPETS = 24;
